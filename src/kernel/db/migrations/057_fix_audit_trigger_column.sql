...
COMMENT ON FUNCTION audit_direct_insert() IS 'Trigger function that audits direct inserts and sends reminders to use areflect or CLI. Fixed in migration 057 to use discovered_by instead of reported_by for issues table.';
